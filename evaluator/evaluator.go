...
// Unwrapping is necessary otherwise a return statement would bubble
// up through several functions and stop the evaluation in all of them
...
func Eval(node ast.Node, env *object.Environment) object.Object {
	...
	case *ast.CallExpression:
		...
		// If an error is encountered, stop the evaluation
